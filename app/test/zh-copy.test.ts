  ...
  const checks: Array<[string, string[]]> = [
    ...
    [
      ...
      [
        ...
        "classification attaches to a specific release",
    ...
    [
      ...
      ["经济模型则把这些花费与它换来的结果", "算力从哪里购买", "训练和推理为何是两类不同的成本", "何时应该自建模型", "何时应该通过 API 购买能力", "推理是否主导全生命周期成本", "每个合格结果的成本"],
    ],
    [
