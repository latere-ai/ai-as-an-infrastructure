...
test("polished chapter openings preserve key source theses", () => {
  const checks: Array<[string, string[]]> = [
    ...
    [
      "en/infrastructure/09-where-learning-hits-limits.qmd",
    ...
    [
      "zh/infrastructure/09-where-learning-hits-limits.qmd",
      ["廉价资源正在接近耗尽", "数据墙、合成数据、在推理上做强化学习", "模仿一个有限的语料", "真正改变了这个答案"],
    ],
    [
      "en/infrastructure/10-the-capability-horizon.qmd",
    ...
    [
      "zh/infrastructure/10-the-capability-horizon.qmd",
      ["不再是一个排行榜数字", "移动的地平线", "测量仪器饱和得比新仪器造出来还快", "可持续的进步", "由算力支撑的短期表象"],
    ],
    [
      "en/infrastructure/11-verification-frontier.qmd",
    ...
    [
      "zh/infrastructure/11-verification-frontier.qmd",
