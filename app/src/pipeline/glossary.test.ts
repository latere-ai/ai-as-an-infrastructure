...
const auditedGlossaryTerms = [
  ...
  { key: "dual-encoder", en: "dual-encoder", zh: "双编码器", files: both("en/orchestration/08-rag-retrieval.qmd", "zh/orchestration/08-rag-retrieval.qmd") },
  { key: "bm25", en: "BM25", zh: "BM25 稀疏检索", files: both("en/orchestration/08-rag-retrieval.qmd", "zh/orchestration/08-rag-retrieval.qmd") },
  { key: "hnsw", en: "hierarchical navigable small-world", zh: "分层可导航小世界图", files: both("en/orchestration/08-rag-retrieval.qmd", "zh/orchestration/08-rag-retrieval.qmd") },
  { key: "hybrid-search", en: "hybrid search", zh: "混合搜索", files: both("en/orchestration/08-rag-retrieval.qmd", "zh/orchestration/08-rag-retrieval.qmd") },
  { key: "cross-encoder", en: "cross-encoder", zh: "交叉编码器", files: both("en/orchestration/08-rag-retrieval.qmd", "zh/orchestration/08-rag-retrieval.qmd") },
  ...
  { key: "human-in-the-loop", en: "human-in-the-loop", zh: "人在回路中", files: both("en/practice/12-human-interface-oversight.qmd", "zh/practice/12-human-interface-oversight.qmd") },
  { key: "calibrated-reliance", en: "calibrated reliance", zh: "校准后的依赖", files: both("en/practice/12-human-interface-oversight.qmd", "zh/practice/12-human-interface-oversight.qmd") },
  { key: "automation-bias", en: "automation bias", zh: "自动化偏差", files: both("en/practice/12-human-interface-oversight.qmd", "zh/practice/12-human-interface-oversight.qmd") },
