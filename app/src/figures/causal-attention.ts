...
const labels = {
  en: {
    ...
    colMask: "+ M",
    colWeight: "α = softmax",
    norm: "softmax over {n:key/keys} ({range}); the row sums to 1",
    ...
    describe: "{head} of Qwen2.5-0.5B, query “{q}” at position {i}, {mask}, q·k divided by {c}: over {n:key/keys} the weights put {top}.",
    causal: "causal mask",
    none: "no mask",
    on: "{p} on “{k}”",
  },
