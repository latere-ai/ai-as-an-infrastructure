...
const labels = {
  en: {
    ...
    evFinish: "R{i} finishes and frees {k:block/blocks}",
    evPreempt: "The pool is full: R{i} is preempted, freeing {k:block/blocks}",
    evFrag: "R{i} waits: {f:block is/blocks are} free, but no {k} are adjacent",
    evFull: "R{i} waits: it needs {k:block/blocks}, and {f:block is/blocks are} free",
