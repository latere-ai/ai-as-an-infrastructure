...
**能力**：可观测性把一个非确定性系统变成可调试的东西，评测把「感觉更好」变成一个能为发布把关的数字。**效率**：网关让在线裁判便宜到可以持续运行，而确定性断言在裁判调用发生之前就拦下了成本低、也更该提前发现的故障。**信任**：一个 LLM 裁判可信到何种程度，取决于它对照人类的校准，而 OTel 基座正是让轨迹与分数能从任何变更条款的厂商那里带走的东西。只有这三者都成立，这个循环才值得搭建；而在 2026 年年中，工具终于成熟到让它们能够成立。
