...
first wall by routing a token to a few of its many experts. A state-space model
breaks the second by replacing attention's quadratic mixing with a linear
