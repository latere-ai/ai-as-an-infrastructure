...
wrong ones [@brown2024monkeys]. The whole chapter turns on this one gap between a
...
framing: these stopped being tricks and became a compute axis with its own
scaling laws.
...
roughly fourteen times larger [@snell2024scaling]. That is the constraint arrow
of the chapter made quantitative: inference compute substituting for parameters.
