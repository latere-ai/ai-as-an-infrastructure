...
digraph axis_map {
  ...
  NVLink [label="NVLink tier\nintra-node, highest bandwidth", shape=box, style="rounded,filled", fillcolor="#e8f0fe"];
  Network [label="inter-node network\nInfiniBand / RoCE, an order slower", shape=box, style="rounded,filled", fillcolor="#fde8e8"];
...
digraph flops_gap {
  ...
  peak [label="peak hardware FLOPs", style="filled", fillcolor="#e8f0fe"];
  busy [label="busy FLOPs\n(device not idle)"];
  hfu  [label="HFU: all FLOPs the hardware ran", style="filled", fillcolor="#fff4e0"];
  mfu  [label="MFU: useful model FLOPs only", style="filled", fillcolor="#e6f4ea"];

  idle    [label="idle loss\nexposed communication + pipeline bubble", shape=note, fillcolor="#fde8e8", style="filled"];
  recomp  [label="recomputation + unfused kernels\nran but not strictly needed", shape=note, fillcolor="#fde8e8", style="filled"];
