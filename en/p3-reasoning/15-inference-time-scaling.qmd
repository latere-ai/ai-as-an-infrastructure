...
wrong ones. @fig-inference-time-scaling-shapes lays out the two shapes and where
the selector decides whether coverage becomes accuracy.
...
substituting for parameters. @fig-inference-time-scaling-allocation traces how the
budget is routed by difficulty.
