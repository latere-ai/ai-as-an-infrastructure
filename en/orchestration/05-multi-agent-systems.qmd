...
converge at all [@berdoz2026agree]. A liveness failure is recoverable by
escalation to a human or a different model. A safety failure is silent and
ships. A system that collapses both into one accuracy number optimizes the
wrong axis. The second is the recognition that correlated failure is how a
