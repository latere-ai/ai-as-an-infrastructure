...
OSWorld-Human makes efficiency visible alongside completion. In its evaluated systems, model calls dominated latency, later steps could take much longer than early ones, and the best agents used 2.7--4.3 times as many steps as the human-authored reference trajectories, the step sequences a person would follow to complete each task [@abhyankar2025osworldhuman]. These measurements hold for the agents and tasks studied. They show that task success alone hides operational quality.
