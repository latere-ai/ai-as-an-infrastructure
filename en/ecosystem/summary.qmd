...
The ecosystem is not scenery around the stack. It is one mechanism by which capability becomes access, lock-in, margin, and operational risk. The open question is how value will be divided among silicon suppliers, clouds, model providers, application companies, workers, and data rights holders as capability becomes easier to rent. Part XI turns those market constraints into operating contracts: once a team buys or hosts capability, it has to run releases, budgets, tenant boundaries, incidents, and human approvals.
