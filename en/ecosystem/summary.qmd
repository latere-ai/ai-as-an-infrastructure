...
The takeaway is that the ecosystem is not scenery around the stack. It is one mechanism by which capability becomes access, lock-in, margin, and operational risk. The open question is how value will be divided among silicon suppliers, clouds, model providers, application companies, workers, and data rights holders as capability becomes easier to rent.
