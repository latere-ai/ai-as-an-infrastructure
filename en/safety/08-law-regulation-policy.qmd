...
These examples do not form a universal US tier system. California's incident clock, Colorado's adverse-outcome review, an Illinois employer's use restriction, and a federal procurement clause attach to different events and actors. A federal preemption strategy (an effort to have federal law override state rules) or an executive order is not itself a judgment that every state rule is invalid.
