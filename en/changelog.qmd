...
- The header and sidebar no longer move when the page bounces at the top or bottom of a chapter. "On this page" floats over the page, so opening or closing it no longer shifts the text; on narrower windows it shows only its title and opens on hover or tap.
