...
This distinction is useful because it prevents two common mistakes. The first is overcorrecting: a noisy result is not evidence of bias; it is evidence that the evaluation lacks power. The second is undercorrecting: a precise result is not evidence of validity; it is only evidence that the measurement is stable under its own assumptions. The varieties of bias are taken up later: @sec-human-evaluation-rubrics on human protocol bias, @sec-judging-holistic on judge bias, and @sec-factuality-grounding on the special case where preference and truth diverge.
