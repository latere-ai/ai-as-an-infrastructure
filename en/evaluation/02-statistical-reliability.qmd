...
When disagreement counts are small, use the exact paired-binomial form rather than leaning on this asymptotic approximation. More importantly, retain the effect estimate and its interval. A test can indicate incompatibility with a zero-difference model; it does not say whether the difference matters.
