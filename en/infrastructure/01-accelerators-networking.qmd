...
//| fig-cap: "Reading the per-step timeline as a descent from peak FLOPs to MFU. Exposed communication and the pipeline bubble are idle loss; recomputation and unfused kernels are work the hardware ran, which is why HFU sits above MFU."
digraph flops_gap {
  bgcolor="transparent";
  node [fontname="Helvetica", color="#6b7280", fontcolor="#6b7280", penwidth=1.1];
  edge [color="#6b7280", fontcolor="#6b7280"];
