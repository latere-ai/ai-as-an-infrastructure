...
The part leaves a practical standard: a model is not infrastructure merely because it is impressive. It must be repeatable at a latency and price someone can operate. The open question is which model and runtime designs will make long-context, multimodal, and structured generation affordable without turning the serving layer into a maze of exceptions.
