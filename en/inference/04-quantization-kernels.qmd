...
are never written in the first place. GPTQ, AWQ, and SmoothQuant make different
outlier bets; INT4, FP8, and GGUF encode different deployment targets;
FlashAttention shows how an IO-aware kernel changes the cost model. The choice
