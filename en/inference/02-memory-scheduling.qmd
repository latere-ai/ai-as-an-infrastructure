...
PagedAttention removes fragmented cache and makes prefix sharing cheap.
Radix-tree prefix caching reuses shared prompts but leaves prefill-decode
interference. Phase splitting removes that interference by paying a network
transfer. Memory layout and scheduling policy are therefore the same serving
