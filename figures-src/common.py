...
ZH_TEXT = {
    ...
    "Parameters": "参数量",
    "audit data path": "审计数据路径",
    "ad hoc stack": "临时拼接栈",
    "capital intensity": "资本强度",
    "cloud": "云",
    "contract coverage": "契约覆盖度",
    "control pressure": "控制压力",
    "data-rights-economics-1": "data-rights-economics-1",
    "differentiation": "差异化",
    "documented": "已文档化",
    "economics-2": "economics-2",
    "economy token price": "经济型词元价格",
    "frontier labs": "前沿实验室",
    "frontier training cost": "前沿训练成本",
    "governed stack": "受治理的栈",
    "interop boundary crossed": "跨越互操作边界",
    "jagged edge": "锯齿边界",
    "licensed / consented": "已许可 / 已同意",
    "local control retained": "保留本地控制",
    "market-structure-1": "market-structure-1",
    "model gateway": "模型网关",
    "model-landscape-2": "model-landscape-2",
    "net productivity effect": "净生产率影响",
    "open source AI": "开源 AI",
    "policy-usable": "政策可用",
    "practical openness": "实际开放度",
    "production-ready": "生产可用",
    "raw web": "原始网页",
    "relative corpus available": "相对可用语料",
    "relative index": "相对指数",
    "review burden": "审查负担",
    "sandbox runtime": "沙箱运行时",
    "silicon": "芯片",
    "study / reproduce": "研究 / 复现",
    "switching cost": "切换成本",
    "task distance from the frontier": "任务距离能力边界",
    "tooling-ecosystem-2": "tooling-ecosystem-2",
    "unpriced risk": "未定价风险",
    "unsafe to accept": "不宜接受",
    "use / modify / share": "使用 / 修改 / 分享",
    "workflow registry": "工作流注册表",
    "years": "年份",
    "Model A": "模型 A",
    "Model B": "模型 B",
    "Model C": "模型 C",
    "score estimate with 95% CI": "带 95% 置信区间的分数估计",
    "visible gap, weak evidence": "看得见的差距，证据仍弱",
    "clearer separation": "更清楚的分离",
    "small": "小模型",
    "routed": "路由组合",
    "frontier": "前沿模型",
    "slow giant": "慢速巨型模型",
    "cheap weak": "便宜但弱",
    "relative cost per task": "每任务相对成本",
    "task quality": "任务质量",
    "dominated: more cost\nwithout useful quality": "被支配：成本更高\n质量没有有用提升",
    "bubble size = latency": "气泡大小 = 延迟",
