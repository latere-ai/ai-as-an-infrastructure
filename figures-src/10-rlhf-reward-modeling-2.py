...
fig.tight_layout()
for _out in (
    "/Users/changkun/dev/latere.ai/ai-as-an-infrastructure/en/figures/10-rlhf-reward-modeling-2.svg",
    "/Users/changkun/dev/latere.ai/ai-as-an-infrastructure/zh/figures/10-rlhf-reward-modeling-2.svg",
):
