...
- [x] **Large agent populations and 2026 alignment findings.** Done 2026-09-24: population mechanism in `orchestration/07`, alignment audits and control research in `safety/02`, containment in `safety/04`, dated items on the State of the Field page.
